...
public:
     ...
     */
    virtual void updateByWalk(WalkDataType walk, wid_t walkid, bid_t exec_block, eid_t *&beg_pos, vid_t *&csr, WalkManager &walk_manager ,std::vector<bool> &used_csr,std::vector<bool> &used_csr_v){ //, VertexDataType* vertex_value){
